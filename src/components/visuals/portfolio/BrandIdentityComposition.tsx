  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-[540px] h-[210px] sm:h-[250px] md:h-[280px] flex items-center justify-center">
        ...
        <div className="hidden sm:flex absolute -right-2 sm:right-2 top-1 sm:top-2 w-[110px] sm:w-[130px] md:w-[150px] h-[130px] sm:h-[155px] md:h-[175px] rounded-xl bg-gradient-to-b from-[#181a24] via-[#12141c] to-[#0c0d12] border border-white/10 shadow-[0_15px_30px_rgba(0,0,0,0.8)] rotate-0 sm:rotate-[10deg] transform transition-transform duration-500 p-3 flex-col justify-between z-10 gpu-layer">
          {/* Twisted Rope Handles */}
          <div className="w-12 h-6 mx-auto -mt-6 border-2 border-[#ffbe1a]/70 rounded-t-full" />
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 sm:-translate-x-[55%] sm:-translate-y-[52%] w-[240px] sm:w-[310px] md:w-[360px] h-[145px] sm:h-[185px] md:h-[210px] rounded-2xl bg-[#0e1017] border-2 border-white/15 shadow-[0_15px_35px_rgba(0,0,0,0.9)] rotate-0 sm:rotate-[-4deg] transform transition-transform duration-500 p-3 sm:p-4 flex flex-col justify-between z-20 overflow-hidden gpu-layer">
        ...
        <div className="absolute -left-2 sm:left-1 bottom-1 sm:bottom-2 z-30 flex flex-col gap-1.5 transform transition-transform duration-500 gpu-layer">
          {/* Card 1: Obsidian Matte with Embossed Gold */}
          <div className="w-[125px] sm:w-[155px] md:w-[175px] h-[75px] sm:h-[92px] md:h-[105px] rounded-xl bg-gradient-to-br from-[#1a1c26] via-[#10121a] to-[#08090d] border border-[#ffbe1a]/60 shadow-[0_15px_30px_rgba(0,0,0,0.9)] rotate-0 sm:rotate-[-8deg] transform transition-transform duration-500 p-2.5 sm:p-3 flex flex-col justify-between relative overflow-hidden">
        ...
        <div className="absolute right-3 sm:right-6 bottom-0 sm:bottom-1 w-[75px] sm:w-[95px] md:w-[110px] h-[130px] sm:h-[160px] md:h-[185px] rounded-2xl bg-black border-2 border-slate-700 shadow-[0_15px_35px_rgba(0,0,0,0.9)] rotate-0 sm:rotate-[6deg] transform transition-transform duration-500 p-1.5 flex flex-col justify-between z-30 overflow-hidden gpu-layer">
        ...
        <div className="hidden xs:flex absolute left-[38%] sm:left-[42%] bottom-0 sm:bottom-1 w-[45px] sm:w-[55px] md:w-[65px] h-[50px] sm:h-[62px] md:h-[72px] rounded-lg bg-gradient-to-b from-[#222533] via-[#141620] to-[#090a0e] border border-white/20 shadow-[0_15px_30px_rgba(0,0,0,0.9)] rotate-0 sm:rotate-[2deg] transform transition-transform duration-500 p-1.5 flex-col justify-between z-40 gpu-layer">
          {/* Mug Handle */}
        ...
        <div className="hidden sm:flex absolute left-1/4 top-1 sm:top-2 z-40 bg-black/90 border border-[#ffbe1a]/40 px-2 sm:px-2.5 py-1 rounded-full shadow-lg items-center gap-1.5 transform -rotate-4 gpu-layer">
          <div className="w-2 h-2 rounded-full bg-[#ffbe1a]" />
