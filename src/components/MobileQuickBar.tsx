...
export const MobileQuickBar: React.FC<MobileQuickBarProps> = ({
  ...
  const whatsappUrl = getWhatsAppUrl(
    ...
    siteSettings.whatsappPrefilledMessage || "Hi Lizzdo Media! I'd like to discuss a project with your team."
  );
    ...
    >
      <div className="max-w-md mx-auto flex items-center justify-between gap-2">
        ...
        <a
          ...
          aria-label="Chat with Lizzdo Media on WhatsApp"
        >
        ...
        <a
          href={siteSettings.phone ? `tel:${siteSettings.phone.replace(/[^0-9+]/g, '')}` : `mailto:${siteSettings.contactEmail || 'contact@media.lizzdo.com'}`}
